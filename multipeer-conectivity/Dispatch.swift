...
//  Copyright © 2016 Dev Core, S.R.L. All rights reserved.
//
...
extension Dispatch {
    ...
    public static func async(_ queue: DispatchQueue = DispatchQueue(label: "dlqueue_identifier", attributes: []), delay: Double = 0.0, block: @escaping Block) {
